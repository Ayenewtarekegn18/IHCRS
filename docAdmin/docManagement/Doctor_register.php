...
$sql = "INSERT INTO doctors (Fname, Lname, Speciality, dob, Region, regDate, City, pnum, email, pass) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?)";
$stmt = $con->prepare($sql);

// Bind the values to the SQL statement
$stmt->bind_param("ssssssssss", $firstname, $lastname, $speciality, $dateofbirth, $region, $registrationdate, $city, $phonenumber, $email, $password);
if ($i==1){
$stmt->execute();
}
